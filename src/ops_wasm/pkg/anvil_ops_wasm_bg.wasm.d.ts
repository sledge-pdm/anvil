...
export const rgbabuffer_getPixel: (a: number, b: number, c: number) => any;
export const rgbabuffer_setPixel: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
...
export const rgbabuffer_resize_with_origins: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
