...
export function resize_instant(target: Uint8Array, target_width: number, target_height: number, source: Uint8Array, source_width: number, source_height: number, src_origin_x: number, src_origin_y: number, dest_origin_x: number, dest_origin_y: number): void;
/**
...
export class PatchBufferRgbaOption {
  free(): void;
  [Symbol.dispose](): void;
  constructor(antialias_mode: AntialiasMode);
